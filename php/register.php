...
//error_reporting(E_ALL);
    ...
    if(!checkDuplicate($user -> email)) {
        ...
        if($statement -> execute())
        {
            ...
            $body = "Hello New User,\r\n\r\n You have just registered for Georgia Tech's GameFest taking place April 19th-20th.\r\n\r\n To complete your registration please login at http://gtgamefest.com and pay your registration fee, this will allow you to particiapte in any tournaments taking place during the event.\r\n\r\n See You There,\r\n-GT Gamefest Staff";
