...
object TournamentEntity extends Entity[Int, SurrogateIntId, Tournament]("tournaments") {
  val id = key("id") autogenerated(_.id)
...
object EventEntity extends Entity[Int, SurrogateIntId, Event]("events") {
  ...
  val games = manytomany(GameEntity) join("game_events","eventId","gameId") to (_.games)
