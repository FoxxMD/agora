...
object UserEntity  extends Entity[Int, SurrogateIntId, User]("users") {
  ...
  def constructor(implicit m: ValuesMap) = new User(email, role, firstName, lastName, globalHandle, createdDate) with Stored {
...
object TeamEntity extends Entity[Int, SurrogateIntId, Team]("teams") {
  ...
  val games = manytoone(GameEntity) foreignkey  "gameId" to (_.game)

  def constructor(implicit m: ValuesMap) = new Team(name, createdDate, games, users) with Stored {
...
object GameEntity extends Entity[Int, SurrogateIntId, Game]("games"){
  ...
  def constructor(implicit m: ValuesMap) = {
    ...
    new Game(name, publisher, website, g) with Stored {
...
object TournamentEntity extends Entity[Int, SurrogateIntId, Tournament]("tournament") {
  ...
  def constructor(implicit m: ValuesMap) = {
    ...
    new Tournament(b, j, game, event, users, teams) with Stored{
...
object EventEntity extends Entity[Int, SurrogateIntId, Event]("events") {
  ...
  def constructor(implicit m: ValuesMap) = {
    ...
    new Event(id, name, e, details, users, tournaments) with Stored}
}
