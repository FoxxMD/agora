...
ALTER TABLE eventdetails ADD FOREIGN KEY (events_id) REFERENCES events (id);
ALTER TABLE eventpayments ADD FOREIGN KEY (events_id) REFERENCES events (id);
...
ALTER TABLE games_events ADD FOREIGN KEY (events_id) REFERENCES events (id);
ALTER TABLE games_events ADD FOREIGN KEY (games_id) REFERENCES games (id);
CREATE INDEX event_game_id_idx ON games_events (events_id);
CREATE INDEX game_event_id_idx ON games_events (games_id);
ALTER TABLE games_tournamenttypes ADD FOREIGN KEY (tournamenttypes_id) REFERENCES tournamenttypes (Id);
ALTER TABLE games_tournamenttypes ADD FOREIGN KEY (game_id) REFERENCES games (id);
CREATE INDEX game_tt_id_idx ON games_tournamenttypes (game_id);
CREATE INDEX tt_id_idx ON games_tournamenttypes (tournamenttypes_id);
ALTER TABLE guilds_games ADD FOREIGN KEY (games_id) REFERENCES games (id);
ALTER TABLE guilds_games ADD FOREIGN KEY (guilds_id) REFERENCES guilds (id);
...
ALTER TABLE teams ADD FOREIGN KEY (games_id) REFERENCES games (id);
ALTER TABLE teams ADD FOREIGN KEY (tournament_id) REFERENCES tournament (id);
CREATE INDEX team_game_id_idx ON teams (games_id);
...
ALTER TABLE user_events ADD FOREIGN KEY (events_id) REFERENCES events (id);
ALTER TABLE user_events ADD FOREIGN KEY (users_id) REFERENCES users (id);
...
ALTER TABLE user_tournaments ADD FOREIGN KEY (tournament_id) REFERENCES tournament (id);
ALTER TABLE user_tournaments ADD FOREIGN KEY (users_id) REFERENCES users (id);
