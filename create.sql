...
ALTER TABLE games_tournamenttypes ADD FOREIGN KEY (games_id) REFERENCES games (id);
...
ALTER TABLE tournamentdetails ADD FOREIGN KEY (tournament_id) REFERENCES tournament (id);
